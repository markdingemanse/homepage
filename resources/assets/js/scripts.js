//Load the feeds
$(document.getElementById("tweakers")).FeedEk( {
...
$(document.getElementById("nos")).FeedEk( {
...
$(document.getElementById("prequelDate")).FeedEk( {
...
$(document.getElementById("whatifDate")).FeedEk( {
...
$(document.getElementById("xkcdDate")).FeedEk( {
...
$(window).load(function(){
    ...
    if (currentmonth == xkcdMonth && currentdate == xkcdDay) {
        $(document.getElementById("xkcd")).FeedEk( {
    ...
    if (currentmonth == whatifMonth && currentdate <= whatifDay) {
        $(document.getElementById("whatif")).FeedEk( {
            FeedUrl : 'http://what-if.xkcd.com/feed.atom',
            MaxCount : 1,
            ShowPubDate : false,
            TitleLinkTarget:'_self',
        ...
        $(document).ready(function () {
            ...
            function checkForItemContent() {
                itemContentPresent = ($('.itemContent').length > 0) ? true : false;
                if (itemContentPresent) {
                    $(document.getElementById("whatif")).find('img').each(function() {
...
if (document.getElementById("searchContainer").addEventListener) {
    // Not FF
    document.getElementById("searchContainer").addEventListener('mousewheel', MouseWheelHandler, false);
    // Firefox
    document.getElementById("searchContainer").addEventListener('DOMMouseScroll', MouseWheelHandler, false);
}
...
// toggleExpandDisable
function toggleExpandDisable() {
    if ( getCookie('expanddisable') != 'true' ) {
        document.cookie='expanddisable=true';
    } else {
        document.cookie='expanddisable=false';
    }
    location.reload();
}
if (getCookie('expanddisable') == 'true') {
    document.getElementById('toggleExpandDisableText').innerHTML = "Enable Expand";
}
...
function expand(dong) {
    if (dong != "dong" && getCookie('expanddisable') == 'true') {
        return;
    }
    document.getElementById("links").className += "content_vexpand";
    document.getElementById("feeds").className += "content_vexpand";
    document.getElementById("condfeeds").className += "largecontent_vexpand";
    document.getElementById("vcenter").className +=  "vcenter_disabled";
    $("#vbottom").find('div').each(function() {
                        $(this).removeClass('arrow-down');
                        $(this).addClass('arrow-up');
                    });
    $("#vbottom").attr('onclick', 'retract(\'dong\');');

}

function retract(dong) {
    document.getElementById("links").className = "";
    document.getElementById("feeds").className = "";
    document.getElementById("condfeeds").className = "";
    document.getElementById("vcenter").className = "";
    $("#vbottom").find('div').each(function() {
                        $(this).addClass('arrow-down');
                        $(this).removeClass('arrow-up');
                    });
    $("#vbottom").attr('onclick', 'expand(\'dong\');');
